...
public class DownloadDocumentoQueryHandler : IRequestHandler<DownloadDocumentoQuery, Result<FileDownloadDTO>>
{
    ...
    public DownloadDocumentoQueryHandler(IDocumentoRepository documentoRepository,
    ...
    public async Task<Result<FileDownloadDTO>> Handle(DownloadDocumentoQuery request,
        CancellationToken cancellationToken)
    {
        ...
        if (fileStreamResult.IsFailure) return Result.Fail<FileDownloadDTO>(fileStreamResult.Error);
