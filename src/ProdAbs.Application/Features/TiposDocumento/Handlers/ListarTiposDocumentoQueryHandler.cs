...
public class
    ListarTiposDocumentoQueryHandler : IRequestHandler<ListarTiposDocumentoQuery,
    Result<List<TipoDocumentoDetalhesDTO>>>
{
    ...
    public async Task<Result<List<TipoDocumentoDetalhesDTO>>> Handle(ListarTiposDocumentoQuery request,
